...
public class putClient extends abstractClientWrapper implements Runnable {
	...
	public void run() {
		...
		service.shutdown();
		try {
			FileWriter service_time = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_60/Results/put_simulation_service_time_60_run1.csv");
			FileWriter result = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_60/Results/put_simulation_result_60_run1.csv");
