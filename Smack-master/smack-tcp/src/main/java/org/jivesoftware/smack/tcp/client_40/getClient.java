...
public class getClient extends abstractClientWrapper implements Runnable {
	...
	public void run() {
		...
		try {
			FileWriter service_time = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_40/Results/get_simulation_service_time_40_run1.csv");
			FileWriter result = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_40/Results/get_simulation_result_40_run1.csv");
