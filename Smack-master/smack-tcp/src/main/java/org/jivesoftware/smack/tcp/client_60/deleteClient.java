...
public class deleteClient extends abstractClientWrapper implements Runnable {
	...
	public void run() {
		...
		try {
			FileWriter service_time = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_60/Results/delete_simulation_service_time_60_run1.csv");
			FileWriter result = new FileWriter("src/main/java/org/jivesoftware/smack/tcp/client_60/Results/delete_simulation_result_60_run1.csv");
