...
public abstract class SASLMechanism implements Comparable<SASLMechanism> {
    ...
    public void authenticate(String host, DomainBareJid serviceName, CallbackHandler cbh, EntityBareJid authzid)
        ...
        Object sc;
		try {
			sc = Sasl.createSaslClient(mechanisms, "test", "xmpp", serviceName.toString(), props, cbh);
		} catch (SaslException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
        try {
			sc = Sasl.createSaslClient(mechanisms, null, "xmpp", serviceName.toString(), props, cbh);
		} catch (SaslException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}*/
